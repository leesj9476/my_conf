...
function __promptline {
  ...
  local x_fg="${wrap}38;5;253${end_wrap}"
  local x_bg="${wrap}48;5;16${end_wrap}"
  local x_sep_fg="${wrap}38;5;16${end_wrap}"
  local z_fg="${wrap}38;5;235${end_wrap}"
  local z_bg="${wrap}48;5;231${end_wrap}"
  local z_sep_fg="${wrap}38;5;231${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
